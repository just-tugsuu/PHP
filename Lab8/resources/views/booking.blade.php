        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <form action = "/booking/{{$id}}" method="post">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="flightNum" class="form-control" value = " {{ $id }}" disabled>
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="passangerName" class="form-control" />
                        </div>
                        <div class="col">
                            @csrf
                            <div class="btn-container">
                                <input name="submit" type="submit" value='Захиалах' class="btn btn-primary">
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="message">
                    ...
                    <p> Захиалга баталгаажсан. Таны захиалгын дугаар {{ \Session::get('success')  }} </p>
                </div>
                @endif
            </div>
        </div>
